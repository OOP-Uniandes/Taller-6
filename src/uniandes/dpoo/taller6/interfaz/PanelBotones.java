...
public class PanelBotones extends JPanel implements ActionListener {
	...
	// REQUERIMIENTO 2
	private final static String ANIADIR_CATEGORIA = "AniadirCategoria";

	// REQUERIMIENTO 3
	private final static String ELIMINAR_LIBROS_DE_AUTOR = "EliminarLibrosDeAutor";
	...
	public PanelBotones(InterfazLibreria interfazLibreria) {
		...
		// REQUERIMIENTO 2
		agregarBoton(ANIADIR_CATEGORIA, "Añadir Categoria", "./data/iconos/libros2.png");

		// REQUERIMIENTO 3
		agregarBoton(ELIMINAR_LIBROS_DE_AUTOR, "Eliminar libros de un autor", "./data/iconos/libros3.png");
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		else if (ANIADIR_CATEGORIA.equals(comando)) {
			ventana.aniadirCategoria();
		} // REQUERIMIENTO 3
		else if (ELIMINAR_LIBROS_DE_AUTOR.equals(comando)) {
			ventana.eliminarLibrosDeAutor();
		}
